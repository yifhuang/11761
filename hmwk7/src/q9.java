...
public class q9 {
	void solve() throws IOException{
		...
		String Path = Utils.vertabi(logll,factorsA,numOfFactorA, factor, trainData.toCharArray(), lamdas, bs, intial, end, numSy, numS, numT);
		//Double betas[][] = Utils.alphaGen(factorsB,numOfFactorB, factor, trainData.toCharArray(), lamdas, bs, intial, end, numSy, numS, numT);
		System.out.println();
		for(int i=Path.length()-1;i>=0;i--){
			System.out.print(Path.substring(i, i+1));
		}
		System.out.println();
